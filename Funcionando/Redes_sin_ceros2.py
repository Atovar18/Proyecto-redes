...
#"C:\Users\Usuario\Desktop\Hola mundo\Sistema\Proyecto-redes\data_io_copia.xlsx"
...
print()
print(AdminHistoria_capa, "capa")
print()

#aplicamos el mismo proceso para los resistores e inductores.

historia_resis_sin_cero = np.where(historia_resis == 0, 1e+15, historia_resis)

AdminHistoria_Resis = 1/ historia_resis_sin_cero
AdminHistoria_Resis = np.round(AdminHistoria_Resis, 4)
print(AdminHistoria_Resis, "resis")
print()
...
print(AdminHistoria_induc, "induc")
print()
