...
df_gen = pd.read_excel("data_io.xlsx","GENERATION")                 #
df_lines = pd.read_excel("data_io.xlsx","LINES")                    #
df_load = pd.read_excel("data_io.xlsx","LOAD")                      #
df_vnom = pd.read_excel("data_io.xlsx", "V_NOM")                    #
...
def run():
   ...
   #Corrientes inyectadas
    ...
    #Y bus
    Y_bus = ybus.ybus(1_gen, carga, linea, Numero_Barras,Linea_Barra_i,Linea_Barra_j,y_shunt, Long)
