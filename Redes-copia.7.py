...
Zelement = np.sum ((historia_induc, historia_capa, historia_resis) ,axis = 0)
print (Zelement , "me cago en la ostia")
AdmitanciasElem = 1/Zelement
AdmitanciasElem = np.round (AdmitanciasElem, 4)

#PLanteamos una matriz que nula, para fabricar la nueva matriz de admitancias.
matriz_nula = np.zeros((c, c), dtype= np.complex64)
np.fill_diagonal(matriz_nula, AdmitanciasElem )
